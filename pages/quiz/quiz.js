        ...
        <seção class="alternativas">
            <form action="">
                <label for="alternativa_a">
                    <input type="radio" id="alternativa_a" name="alternativa" value="${ alterarSinais ( quiz . perguntas [ pergunta - 1 ] . opções [ 0 ] ) }">
                    <div>
                        <span>A</span>
                ...
                <label for="alternativa_b">
                    <input type="radio" id="alternativa_b" name="alternativa" value="${ alterarSinais ( quiz . perguntas [ pergunta - 1 ] . opções [ 1 ] ) }">
                    <div>
                        <span>B</span>
                ...
                <label for="alternativa_c">
                    <input type="radio" id="alternativa_c" name="alternativa" value="${ alterarSinais ( quiz . perguntas [ pergunta - 1 ] . opções [ 2 ] ) }">
                    <div>
                        <span>C</span>
                ...
                <label for="alternativa_d">
                    <input type="radio" id="alternativa_d" name="alternativa" value="${ alterarSinais ( quiz . perguntas [ pergunta - 1 ] . opções [ 3 ] ) }">
                    <div>
                        <span>D</span>
